...
from APPS.Personalizacion.API.SerializerPersonalizacion import (
    SerializerMuebleBase, SerializerColorMaterial, SerializerMuebleColorModelo3D
)
...
class MuebleColorModelo3DViewsSet(ModelViewSet):
    queryset = MuebleColorModelo3D.objects.all()
    serializer_class = SerializerMuebleColorModelo3D
    permission_classes = [AllowAny]
